...
ActiveRecord::Schema[7.1].define(version: 2024_08_06_113643) do
  ...
  create_table "ingredient_amounts", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["product_id", "stock_id"], name: "index_ingredient_amounts_on_product_id_and_stock_id", unique: true
